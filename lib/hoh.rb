...
def naming_system
  ...
  life = {:label=> 'Kingdom', :sub_category=> {:label=> 'Phylum', :sub_category=> {:label=> "CLass", :sub_category=> {:label=> "Order", :sub_category=> {:label=> "Family", :sub_category=> {:label=> "Genus", :sub_category=> {:label=> "Species"}}}}}}}
